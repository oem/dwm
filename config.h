...
/* tagging */
static const char *tags[] = { "USR", "DEV", "SYS", "COM" };
...
/* commands */
static const char *dmenucmd[] = { "dmenu_run", "-fn", "Tamsyn:pixelsize=20", "-nb", colors[0][ColBG], "-nf", colors[0][ColFG], "-sb", colors[1][ColBG], "-sf", colors[1][ColFG], NULL };
